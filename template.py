# this is the main template of our project, by running every folders n files will be created

import os
from pathlib import Path

project_name = "src"
# creating all these under src
list_of_files = [
    ...
    "app.py",  # from here not in src folder
    "requirements.txt",
    "Dockerfile",
    ".dockerignore",
    "demo.py",
